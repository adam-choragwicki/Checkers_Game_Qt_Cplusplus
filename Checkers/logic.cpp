...
std::vector<Piece*> Logic::WhichPiecesCanMove(const std::map<Coordinates, Piece*>& piecesPlacement)
{
...
std::vector<Piece*> Logic::WhichPiecesCanCapture(const std::map<Coordinates, Piece*>& piecesPlacement)
{
